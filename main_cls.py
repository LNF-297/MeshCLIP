...
def parse_args():
    ...
    parse.add_argument('--clip_model', type=str, default='ViT-L/14@336px', help='Available clip models:'+str(clip.available_models())+'[default: ViT-L/14@336px]')
    parse.add_argument('--dataset_path', type=str, default=os.path.join('.', 'data', 'ModelNet40_Processed'), help='dataset path')
